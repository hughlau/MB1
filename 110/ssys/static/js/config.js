...
if (window.location.protocol == "file:") {
    ...
    window.ctx = window.location.protocol + "//" + window.location.host + "/ssys/";
}
...
window.server = "http://micbuy.cn:8033/";//接口地址项目（tianti-module-interface）部署（以用户自己实际情况来定）
...
window.routerList = {
    ...
    menuAndTextlist: window.root + "menuAndTextlist/list.html",
