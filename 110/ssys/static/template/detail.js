jc.data.setup(function (data) {
    ...
    html += '<a href="javascript:;" onclick="window.open(\'https://mp.weixin.qq.com/mp/profile_ext?action=home&__biz=MzUxMTEwMzgzMQ==&scene=124#wechat_redirect\')"><span>寸草春晖情</span></a>';
